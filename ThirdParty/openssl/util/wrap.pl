...
BEGIN {
    ...
    require 'F:/Dev/Massive/ThirdParty/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'F:/Dev/Massive/ThirdParty/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = 'F:/Dev/Massive/ThirdParty/openssl/test/default-and-jitter.cnf';
    shift;
